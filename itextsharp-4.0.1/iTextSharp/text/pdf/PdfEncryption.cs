...
/*
 * $Id: PdfEncryption.cs,v 1.9 2007/01/24 17:42:18 psoares33 Exp $
 *
...
public class PdfEncryption {
    ...
    public const int RC4_40 = 2;
    public const int RC4_128 = 3;
    ...
    public void SetupAllKeys(byte[] userPassword, byte[] ownerPassword, int permissions) {
        ...
        md5.Initialize();
        permissions |= (int)((revision == RC4_128 || revision == AES_128) ? (uint)0xfffff0c0 : (uint)0xffffffc0);
