...
/*
 * $Id: PdfWriter.cs,v 1.32 2007/02/09 15:34:38 psoares33 Exp $
 * $Name:  $
 *
...
namespace iTextSharp.text.pdf {
    ...
    */
    ...
    //  [C9] Metadata
        ...
        */
        private byte[] CreateXmpMetadataBytes() {
            ...
            try {
                XmpWriter xmp = new XmpWriter(baos, pdf.Info);
                xmp.Close();
            }
            catch(IOException) {
            }
    ...
    //  [F1] PdfEncryptionSettings interface
        ...
        /** Type of encryption */
        public const int ENCRYPTION_RC4_40 = 0;
        /** Type of encryption */
        public const int ENCRYPTION_RC4_128 = 1;
        /** Type of encryption */
