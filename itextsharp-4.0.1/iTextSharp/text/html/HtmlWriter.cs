...
/*
 * $Id: HtmlWriter.cs,v 1.13 2007/01/28 17:06:46 psoares33 Exp $
 * $Name:  $
 *
        ...
        protected void Write(IElement element, int indent) {
            ...
            switch (element.Type) {
                ...
                case Element.CHUNK: {
                    ...
                    bool tag = IsOtherFont(chunk.Font) || markup.Count > 0 || styleAttributes != null;
                    if (tag) {
                        // start span tag
                        AddTabs(indent);
                ...
                case Element.PHRASE: {
                    ...
                    if (phrase.LeadingDefined) styleAttributes[Markup.CSS_KEY_LINEHEIGHT] = phrase.Leading.ToString() + "pt";
                ...
                case Element.ANCHOR: {
                    ...
                    styleAttributes = new Properties();
                    if (anchor.LeadingDefined) styleAttributes[Markup.CSS_KEY_LINEHEIGHT] = anchor.Leading.ToString() + "pt";
                ...
                case Element.PARAGRAPH: {
                    ...
                    styleAttributes = new Properties();
                    if (paragraph.LeadingDefined) styleAttributes[Markup.CSS_KEY_LINEHEIGHT] = paragraph.Leading.ToString() + "pt";
                ...
                case Element.LISTITEM: {
                    ...
                    styleAttributes = new Properties();
                    if (listItem.LeadingDefined) styleAttributes[Markup.CSS_KEY_LINEHEIGHT] = listItem.Leading.ToString() + "pt";
