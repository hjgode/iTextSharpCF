...
namespace Org.BouncyCastle.Asn1.IsisMtt.Ocsp
{
	...
	*/
		...
		//, ASN1Choice
	{
		...
		private readonly X509CertificateStructure	certificate;
			...
			Asn1TaggedObject tagged)
		{
			switch ((Choice) tagged.TagNo)
			{
				case Choice.AttributeCertificate:
					this.attributeCert = Asn1OctetString.GetInstance(tagged, false).GetOctets();
					break;
				case Choice.PublicKeyCertificate:
					this.publicKeyCert = Asn1OctetString.GetInstance(tagged, false).GetOctets();
					break;
				default:
		...
		*/
		public override Asn1Object ToAsn1Object()
		{
			...
			return certificate.ToAsn1Object();
		}
	}
}
