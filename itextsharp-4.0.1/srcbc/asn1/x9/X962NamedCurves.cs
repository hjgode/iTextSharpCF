...
namespace Org.BouncyCastle.Asn1.X9
{
	...
	public sealed class X962NamedCurves
	{
		...
		static X962NamedCurves()
		{
			...
			curves.Add(X9ObjectIdentifiers.Prime192v1, Prime192v1Holder.Instance);
			curves.Add(X9ObjectIdentifiers.Prime192v2, Prime192v2Holder.Instance);
			curves.Add(X9ObjectIdentifiers.Prime192v3, Prime192v3Holder.Instance);
			curves.Add(X9ObjectIdentifiers.Prime239v1, Prime239v1Holder.Instance);
			curves.Add(X9ObjectIdentifiers.Prime239v2, Prime239v2Holder.Instance);
			curves.Add(X9ObjectIdentifiers.Prime239v3, Prime239v3Holder.Instance);
			curves.Add(X9ObjectIdentifiers.Prime256v1, Prime256v1Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Pnb163v1, C2pnb163v1Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Pnb163v2, C2pnb163v2Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Pnb163v3, C2pnb163v3Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Pnb176w1, C2pnb176w1Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Tnb191v1, C2tnb191v1Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Tnb191v2, C2tnb191v2Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Tnb191v3, C2tnb191v3Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Pnb208w1, C2pnb208w1Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Tnb239v1, C2tnb239v1Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Tnb239v2, C2tnb239v2Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Tnb239v3, C2tnb239v3Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Pnb272w1, C2pnb272w1Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Pnb304w1, C2pnb304w1Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Tnb359v1, C2tnb359v1Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Pnb368w1, C2pnb368w1Holder.Instance);
			curves.Add(X9ObjectIdentifiers.C2Tnb431r1, C2tnb431r1Holder.Instance);
		}
