...
namespace Org.BouncyCastle.Asn1.Sec
{
	public sealed class SecNamedCurves
	{
			...
			: X9ECParametersHolder
		{
			...
			internal const int sect163r2m = 163;
			internal const int sect163r2k1 = 3;
			internal const int sect163r2k2 = 6;
			internal const int sect163r2k3 = 7;
			...
			: X9ECParametersHolder
		{
			...
			internal const int sect233r1m = 233;
			internal const int sect233r1k1 = 74;
			internal const int sect233r1k2 = 0;
			internal const int sect233r1k3 = 0;
			...
			: X9ECParametersHolder
		{
			...
			internal const int sect283r1m = 283;
			internal const int sect283r1k1 = 5;
			internal const int sect283r1k2 = 7;
			internal const int sect283r1k3 = 12;
			...
			: X9ECParametersHolder
		{
			...
			internal const int sect409r1m = 409;
			internal const int sect409r1k1 = 87;
			internal const int sect409r1k2 = 0;
			internal const int sect409r1k3 = 0;
			...
			: X9ECParametersHolder
		{
			...
			internal const int sect571r1m = 571;
			internal const int sect571r1k1 = 2;
			internal const int sect571r1k2 = 5;
			internal const int sect571r1k3 = 10;
		...
		static SecNamedCurves()
		{
			...
			curves.Add(SecObjectIdentifiers.SecT571r1, Sect571r1Holder.Instance);
			curves.Add(SecObjectIdentifiers.SecT409r1, Sect409r1Holder.Instance);       
			curves.Add(SecObjectIdentifiers.SecT283r1, Sect283r1Holder.Instance);
			curves.Add(SecObjectIdentifiers.SecT233r1, Sect233r1Holder.Instance);
			curves.Add(SecObjectIdentifiers.SecT163r2, Sect163r2Holder.Instance);       
			curves.Add(SecObjectIdentifiers.SecP521r1, Secp521r1Holder.Instance); 
			curves.Add(SecObjectIdentifiers.SecP256r1, Secp256r1Holder.Instance);
			curves.Add(SecObjectIdentifiers.SecP224r1, Secp224r1Holder.Instance);             
			curves.Add(SecObjectIdentifiers.SecP384r1, Secp384r1Holder.Instance);             
		}
